...
if (isset($_SESSION['quiz_results'][$quiz_id])) {
    $results = $_SESSION['quiz_results'][$quiz_id];
    // Clear the session data after use
    unset($_SESSION['quiz_results'][$quiz_id]);
} else {
    $results = []; // Fallback if no results are found
}
        ...
        <?php if (!empty($results)): ?>
            <?php foreach($results as $result): ?>
                <div class="question-block">
                    ...
                    <p><strong>Your Answer:</strong> <?php echo htmlspecialchars($result['selected_answer'] ?: 'Not Answered'); ?></p>
